            ...
            if (!_symbolSamples.TryGetValue(type, out sample))
            {
                switch (type)
                {
                    case CSharpSymbolType.Identifier:
                        return Resource.CSharpSymbol_Identifier;
                    case CSharpSymbolType.Keyword:
                        return Resource.CSharpSymbol_Keyword;
                    case CSharpSymbolType.IntegerLiteral:
                        return Resource.CSharpSymbol_IntegerLiteral;
                    case CSharpSymbolType.NewLine:
                        return Resource.CSharpSymbol_Newline;
                    case CSharpSymbolType.WhiteSpace:
                        return Resource.CSharpSymbol_Whitespace;
                    case CSharpSymbolType.Comment:
                        return Resource.CSharpSymbol_Comment;
                    case CSharpSymbolType.RealLiteral:
                        return Resource.CSharpSymbol_RealLiteral;
                    case CSharpSymbolType.CharacterLiteral:
                        return Resource.CSharpSymbol_CharacterLiteral;
                    case CSharpSymbolType.StringLiteral:
                        return Resource.CSharpSymbol_StringLiteral;
                    default:
                        return Resource.Symbol_Unknown;
                }
            }
            return sample;
        }
