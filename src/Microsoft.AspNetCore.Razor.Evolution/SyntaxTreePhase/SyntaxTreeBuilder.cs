...
namespace Microsoft.AspNetCore.Razor.Evolution.SyntaxTreePhase
{
    public class SyntaxTreeBuilder
    {
        ...
        public void Add(Span span)
        {
            ...
            {
                throw new InvalidOperationException(Resource.ParserContext_NoCurrentBlock);
            }
        ...
        public void EndBlock()
        {
            if (_blockStack.Count == 0)
            {
                throw new InvalidOperationException(Resource.EndBlock_Called_Without_Matching_StartBlock);
            }
        ...
        public Block Build()
        {
            if (_blockStack.Count == 0)
            {
                throw new InvalidOperationException(Resource.ParserContext_CannotCompleteTree_NoRootBlock);
            }
            if (_blockStack.Count != 1)
            {
                throw new InvalidOperationException(Resource.ParserContext_CannotCompleteTree_OutstandingBlocks);
            }
