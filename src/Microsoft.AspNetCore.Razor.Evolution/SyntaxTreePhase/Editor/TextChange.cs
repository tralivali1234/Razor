...
namespace Microsoft.AspNetCore.Razor.Evolution.SyntaxTreePhase.Editor
{
    public struct TextChange
    {
            ...
            : this()
        {
            ...
            if (oldPosition < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(oldPosition), Resource.FormatArgument_Must_Be_GreaterThanOrEqualTo(0));
            }
            if (newPosition < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(newPosition), Resource.FormatArgument_Must_Be_GreaterThanOrEqualTo(0));
            }
            if (oldLength < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(oldLength), Resource.FormatArgument_Must_Be_GreaterThanOrEqualTo(0));
            }
            if (newLength < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(newLength), Resource.FormatArgument_Must_Be_GreaterThanOrEqualTo(0));
            }
